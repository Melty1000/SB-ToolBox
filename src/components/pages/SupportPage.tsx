...
import {
    ...
    Globe, Youtube, Twitch, List, Activity, Heart, Users, Brain, ShoppingBag, Gift, Instagram
} from 'lucide-react';
...
interface InspirationRowProps {
    ...
    logo?: string;
    desc: string;
    socials: InspirationSocial[];
    twitchHandle?: string;
}

interface InspirationSocialBtnProps {
    icon: IconComponent;
    href: string;
    brandColor: string;
}
                ...
                <div className="flex flex-col gap-8">
                    <div className="max-w-none">
                        <p className="text-melt-text-label text-sm font-mono leading-relaxed px-1 whitespace-pre-wrap">
                            I create because I love to. I&apos;m deeply passionate about my projects, and I strive to push the boundaries of quality in everything I release. At the end of the day, I do what I love to make people smile, and seeing my ideas become tangible products is rewarding.
                        </p>
                    </div>
                ...
                <div className="flex flex-col gap-10 w-full pl-6 border-l border-melt-text-muted/10">
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-x-12 gap-y-10 w-full">
                        <InspirationRow
                            ...
                            desc="I cannot praise this man enough. He is the reason I started building tools for Streamer.bot. Every utility he releases is incredible and top-notch. My entire style is heavily inspired by him. And though he doesn't know it, I could never thank him enough for what he has done for this community. If there is one person to check out from this list, this is my strongest recommendation."
                            socials={[
                        ...
                        <InspirationRow
                            ...
                            desc="I can't count the number of times I&apos;ve been in a bind and Pwnyy was immediately available in the official SB Discord #general. Several of my projects would not exist without him, whether he knows it or not."
                            socials={[
                        ...
                        <InspirationRow
                            name="GaelLevel"
                            logo={withBasePath("/assets/gael_level_pfp.png")}
                            desc="If you want to learn about asset and scene creation, Gael is the person to watch. He was the first creator I really locked in on and learned from. His tutorials are top-tier."
                            socials={[
                        ...
                        <InspirationRow
                            ...
                            desc="Whether Pwnyy is around in #general or not, this awesome dude is usually in the shadows helping people out. I&apos;ve enjoyed our conversations and I&apos;m extremely appreciative of everything you&apos;ve done for this community."
                            socials={[
                        ...
                        <InspirationRow
                            ...
                            desc="He doesn&apos;t publish as much as he used to, but leaving him out would mean skipping a true pillar of the community."
                            socials={[
                        ...
                        <InspirationRow
                            name="GoWMan"
                            logo={withBasePath("/assets/gowman_pfp.png")}
                            desc="You might not see him in Discord as often as some others on this list, but he&apos;s an alien and who doesn&apos;t love aliens? I also enjoy hanging out in his streams."
                            socials={[
                        ...
                        <InspirationRow
                            ...
                            desc="A real legend to a lot of content creators for his Spotify and AI chat plugins. The foundation for my first few projects came directly from his work and YouTube tutorials."
                            socials={[
                        ...
                        <InspirationRow
                            ...
                            desc="If you need help with Move, or any other OBS plugin, this is probably your guy. I&apos;ve used plenty of his projects, and he&apos;s one of the best-known creators on this list. His YouTube videos are consistently high quality."
                            socials={[
                        ...
                        <InspirationRow
                            ...
                            desc="I only recently met this guy, but he has great vibes and is an up-and-comer in the SB space like me. He puts quality into everything he does, and I highly suggest checking him out."
                            socials={[
            ...
            <div className="flex flex-col gap-8 w-full pl-6 border-l border-melt-text-muted/10">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-x-12 gap-y-10 w-full">
                    ...
                    <InspirationRow
                            ...
                            desc="This man is incredibly knowledgeable about streaming, tech, and much more. In case you were wondering, Milty was right. Also my supposed evil twin."
                        socials={[
                    ...
                    <InspirationRow
                            ...
                            desc="I might have spent more time in this man&apos;s stream than anyone else recently. Incredibly chill streams, and he usually laughs at my absolutely unhinged jokes. I can&apos;t wait for our friendship to keep growing."
                        socials={[
...
function SocialRow({ icon, label, desc, href, color }: SocialRowProps) {
    return (
...
function InspirationRow({ name, logo, desc, socials, twitchHandle }: InspirationRowProps) {
    ...
    return (
        <div className="flex flex-col md:flex-row gap-4 md:gap-6 group/inspiration w-full">
            ...
            <div className={cn(
                ...
                <div className="w-full h-full rounded-full bg-melt-text-muted/5 border border-melt-text-muted/10 flex items-center justify-center shrink-0 overflow-hidden group-hover/inspiration:border-melt-accent/30 transition-all duration-500 shadow-[0_0_0_1px_rgba(113,113,122,0.22)] relative">
                    {logo ? (
                        <img
                            src={logo}
                            alt={name}
...
function InspirationSocialBtn({ icon: Icon, href, brandColor }: InspirationSocialBtnProps) {
